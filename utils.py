...
def not_a_stopword(t):
    return not t.isnumeric() and len(t.strip(' ….!_?')) > 0 and t not in punctuation and not_a_language_stop_word(t)


# Add different language stop_word checking here
def not_a_language_stop_word(t):
    return t not in arabic_stopwords and t not in english_stopwords and t not in german_stopwords
